...
Given a user prompt, generate a song following these rules.
...
If user requests instrumental, use a loose structure guide:
...
1. **Instrumental requested?** → Use structure tags only, no vocal lyrics
...
{
  "song_title": string,
  "prompt": string,        // Detailed music description (style, instruments, emotion, timbre, etc.)
  "lyrics": string,        // Lyrics with structure tags, or instrumental structure
